...
for (let dataType in myPet) {
    let details = myPet[dataType];
    console.log("Q3: " + dataType + ": " + details);
}
...
const pets = [
    { name: "Anthony", species: "lion", color: "orange" },
    { name: "Benedict", species: "dog", color: "golden" },
    { name: "Collin", species: "fish", color: "green" }
]

function printPets(list) {
    console.log("Q6: ")
...
let dog1 = new Dog("Nate", "golden retriever", 12)

let dog2 = new Dog("Chuck", "labradoodle", 12)
...
let dog3 = new Dog("Nate", "golden retriever", 12)

let dog4 = new Dog("Chuck", "labradoodle", 12)
